<template>
  <template v-if="fetchServerListsFlag">
...
const {serverStore,getServerIP,fetchServerListsFlag}=useServerStore()
watch(
    ()=>fetchServerListsFlag.value,
    ()=>{
      dashboardStore.showPreloaderFlag = !fetchServerListsFlag.value;
      console.log(dashboardStore.showPreloaderFlag)
    },{
      immediate:true
    }
)
